...
### **3）生成式大模型的应用**  
  #### 后端代码实现
  核心后端逻辑100%通过 Claude Sonnet 生成，借助 Cursor 结合自定义的 cursorrules，[arch.md](./arch.md)，update_log.md 实现开发过程中对 Cursor 的能力增强&管理。使用 Cursor vibe coding 有几处一直受人诟病的问题，随着项目体积越来越大，问题越发突出
