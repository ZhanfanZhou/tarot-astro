...
本项目是一款面向大众用户的 **AI 塔罗与星座占卜应用**，通过 Google Gemini 模型与精心设计的交互流程，为用户提供轻量但有情绪价值的占卜咨询体验。  
核心能力包括：
...
- **游客零门槛体验 + 账号体系**：支持游客立即体验，并提供一键转为注册用户、保留完整历史的路径。
- **沉浸式 UI 与抽牌动画**：通过高完成度的视觉与动效设计，营造“在线神秘学工作室”的仪式感。

从产品形态上看，它既是一个 “随身占卜师”，也是一个围绕用户情绪与决策场景的陪伴型工具。

---

## 2. 关键特性（在原有文案基础上的整理与扩展）
### 个性化解读

1. 为每个用户单独打造的记事本long term memory，能够记住用户过往的信息，AI能够给出更有参与感和个性化的回答。产生价值：能给出更有情绪价值的回答，产生更强的用户链接。例如后续占卜中，AI 可以主动调用“读取笔记本”的工具，把这些历史线索串起来，形成“我记得你上次也在纠结 xx……”的连续性叙事。  
...
2. 占卜中度的把控，优秀的占卜师都有一个共同的特质，就是让问卜者感觉精准，这种精准不是模糊笼统的说法带来的，而是经验和牌意的精准结合。在agent实现中，为了尽可能占卜师能获取问卜者的基本个人(年龄性别星座mbti)信息，通过占卜记事本保留的长期记忆，做出合适的解读
...
1. 设计了两个风格不同的占卜agent，满足用户不同的需求，模拟不同性格的占卜师。在语气、话术节奏和解读风格上对两位虚拟占卜师做了差异化设定，如一位更柔和轻松，一位更直接。
...
3. 低进入门槛，使用门槛极低，游客身份不需要输入任何个人信息即可开始使用，关键的个人信息允许在占卜过程中有需要时AI发起补充信息
4 完全由AI控制的占卜节奏，市场上大部分产品是预设常问问题，指定牌阵，AI只负责解读。如果问题模糊，或者问题根本不适合使用塔罗牌解答，占卜体验会很差。占卜节奏完全交给

- **科学占卜流程——从“讲牌意”转向“共创答案”**  
  - 系统提示词与对话流程都围绕“回到问卜者身上”设计：AI 会先澄清真实诉求，再建议牌阵/星盘角度，而不是直接输出长篇牌意说明。  
  - 流式输出与多轮引导结合，让每一次回答都留有“继续说、再问一点”的空间，而不是“一次性讲完所有可能”。  
  - **产品价值**：相比“内容很多但像模板”的解读，本产品更强调过程参与感和决策支持，满足用户“被陪伴、一起思考”的需求。

- **两种不同人格的占卜 Agent**  
  - 在系统提示、语气、话术节奏上，对两位虚拟占卜师做了差异化设定，如一位更温柔安抚，一位更直给理性。  
  - 并为两者准备不同的默认开场白与引导语，使用户在反复使用过程中，形成对“这个占卜师”的风格预期。  
  - **产品价值**：同一套底层能力，通过人格化包装，提升记忆点与复访率。

- **沉浸式体验——从“问答界面”到“占卜现场”**  
  - 抽牌器设计了多种随机洗牌动画、扇形牌阵、可拖动的牌组视角，用户需要“亲自选牌”，而不是点一下按钮被动接收结果。  
  - 背景采用神秘学主题的动态光效、帷幕、水晶球等视觉元素，同时控制信息层级，确保在“好看”的前提下不干扰阅读。  
  - **产品价值**：相比纯文本对话，抽牌和环境的“仪式感”强化了用户对结果的投入度和情绪记忆。

- **低门槛与渐进式信息收集**  
  - 初次进入即可以游客身份开始占卜，用户只在确实需要（如星盘解读）时被温和地引导补充出生信息。  
  - 设计“游客转注册用户”的路径，允许用户在发现内容有价值后再决定是否长期沉淀自己的数据和历史记录。  
  - **产品价值**：最大化降低冷启动阻力，同时保留后续转化空间。
...
- 产品设计刻意反对在占卜过程中的单向输出，反对“把塔罗/星盘当成知识库讲解”的做法，反对为了追求“准确”而说空话，利用巴纳姆
- 效应让问卜者觉得准，而是是让模型在和问卜者的多轮对话中，逐渐建立链接，焦点永远回归本人现阶段、情绪状态和真实困惑。  
...
- **1）什么都问型——高频陪伴用户**  
  ...
  - 核心需求：稳定的人格感（“熟悉的占卜师”）、记得自己过往经历的“老朋友式陪伴”、不需要每次重新解释背景。  
...
- **1）会员订阅制（基础变现主轴）**  
  ...
  - 高级层：提供“长周期陪伴方案”，例如每周/每月自动推送“本周运势 + 与上次占卜对照”的专属报告。

- **2）一次性付费内容 / 主题套餐**  
  - 主题牌阵包：如“感情疗愈系列”“事业转折期系列”“年度复盘与新年愿望”等。  
  - 深度报告：基于星盘 + 历史笔记生成 PDF / Markdown 报告，可导出或打印，作为仪式感极强的“命盘档案”。  
  - 特殊节日活动：情人节、生日、年末等节点的限时主题牌阵或活动。
...
- **4）B 端 / 合作渠道**  
  - 为内容平台、社群 App 提供“嵌入式占卜服务”组件，以 API 或白标方式输出。  
  - 与情绪咨询、心理内容产品合作，为其提供轻量玄学入口，增加用户黏性。
